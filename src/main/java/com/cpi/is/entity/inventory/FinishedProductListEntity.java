...
public class FinishedProductListEntity implements Serializable {
	...
	public FinishedProductListEntity(Long fplId, String skuCD, Integer quantity, Integer branchId, Date dateFinished) {
		super();
		this.fplId = fplId;
		this.skuCD = skuCD;
	...
	public String toString() {
		return "FinishedProductListEntity [fplId=" + fplId + ", skuCD=" + skuCD + ", quantity=" + quantity
				+ ", branchId=" + branchId + ", dateFinished=" + dateFinished + ", sku=" + sku + ", branch=" + branch
				+ "]";
	}
