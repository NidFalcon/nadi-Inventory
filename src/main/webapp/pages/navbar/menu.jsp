...
<div class="offcanvas offcanvas-start" tabindex="-1" id="navbarOffcanvasLg" aria-laballededby="navbarOffcanvasLgLabel">
	<ul class="navbar-nav ms-3 me-auto mb-2 mb-lg-0">
		<li class="navbar-brand"><img src="images/icon.png" class="me-1 menuIcon"><span>Patisserie Plain</span></li>
			
			<!--menu header-->
			<div class="offcanvas-header">
				<h5 class="offcanvas-title" id="navbarOffcanvasLgLabel">
					<i class="bi bi-box-fill me-1"></i>Patisserie Plain </h5>
			...
			<div class="offcanvas-body">
				<ul class="navbar-nav flex-wrap pe-3">
					...
					<li class="nav-item"><a class="nav-link" href="#" id="btnReports"><i class="bi bi-clipboard-data-fill me-1"></i>Reports</a>
					</li>
					<li class="nav-item"><a class="nav-link" href="#" id="btnDispatching"><i class="bi bi-truck me-1"></i>Dispatch</a>
					</li>
					<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
