<div class="m-4 mainWrapper">
	<main role="main">
		<div
			class="d-flex justify-content-between align-items-center contentNavbar">
			<h1 class="h2">
			...
			<div class="btn-toolbar mb-2 mb-md-0 me-3 ms-2">
				<button type="button" class="btn btn-primary me-2"
					...
					id="btnShowAddDispatching">+ Add</button>
				<button type="button" class="btn btn-primary me-2"
					data-bs-toggle="modal" data-bs-target="#updateModal"
					id="btnShowUpdateDispatching">Update</button>
				<button type="button" class="btn btn-danger me-2"
					data-bs-toggle="modal" data-bs-target="#deleteModal" id="btnDelete">Delete</button>
			</div>
		</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header border-0 modalHeader">
					...
					<button type="button" class="btn-close btnCloseAddModal"
				...
				<div class="modal-body border-0 modalBody">
					<form>
						...
						<div class="mb-3">
							<label for="selFinishedProdId">Finished Product List</label> <select
								id="selFinishedProdId" class="form-select selFinishedProd">
						...
						<div class="row mb-3">
							<div class="col-sm-6">
								...
								<input type="text" id="txtQuantityFPL"
									class="form-control txtQuantityFPL" readonly="readonly" />
							</div>
							<div class="col-sm-6">
								<label for="txtDateFinished" class="col-form-label">Date
									Finished</label> <input type="text" id="txtDateFinished"
									class="form-control txtDateFinished" readonly="readonly" />
							</div>
						</div>
						<div class="mb-3">
						...
						<div class="mb-3">
							<label for="material-date">Dispatch Date:</label> <input
								id="dateSelected" class="form-control" type="date" />
						</div>
					</form>
				</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body border-0 modalBody">
					<form>
						...
						<div class="mb-3">
							<label for="updateFinishedProductId">Finished Product
								List</label> <select id="updateFinishedProductId"
								class="form-select updateFinishedProductId">
								<option></option>
							</select>
						</div>
						<div class="row mb-3">
							<div class="col-sm-6">
								<label for="txtQuantityFPL" class="col-form-label">Quantity</label>
								<input type="text" class="form-control txtQuantityFPL"
									readonly="readonly" />
							</div>
							<div class="col-sm-6">
								<label for="txtDateFinished" class="col-form-label">Date
									Finished</label> <input type="text"
									class="form-control txtDateFinished" readonly="readonly" />
							</div>
						</div>
						<div class="mb-3">
						...
						<div class="mb-3">
							<label for="material-date">Dispatch Date:</label> <input
								id="updateDate" class="form-control" type="date" />
						</div>
					</form>
				</div>
				<div class="modal-footer border-0 modalFooter">
