...
<div class="m-4 mainWrapper">
	<main role="main">
		<div class="d-flex justify-content-between align-items-center contentNavbar">
			<h1 class="h1"><i class="bi bi-boxes me-2 ms-3"></i>Dispatch </h1>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header border-0 modalHeader">
					...
					<button type="button" class="btn-close btnCloseAddModal" data-bs-dismiss="modal" aria-label="Close"></button>
				</div>
				<div class="modal-body border-0 modalBody">
					<form>
						<div class="mb-3 d-none">
							...
							<input type="text" class="form-control" id="addBranchId" value="0" placeholder="0" readonly>
						</div>
						<div class="mb-3">
						...
						<div class="mb-3">
							<label for="selFinishedProdId">Finished Product List</label> <select id="selFinishedProdId" class="form-select selFinishedProd">
						...
						<div class="mb-3">
							...
							<input type="number" class="form-control" id="addDispatchQuantity">
						</div>
						<div class="mb-3">
							<label for="addDispatchDestination" class="col-form-label">Destination:</label>
							<input type="text" class="form-control" id="addDispatchDestination">
						</div>
						<div class="mb-3">
				...
				<div class="modal-footer border-0 modalFooter">
					<button type="button" class="btn btn-success btnConfirmDate">Confirm Date</button>
					<button type="button" class="btn btn-secondary btnCloseAddModal" data-bs-dismiss="modal" id="btnCloseAddModal">Close</button>
					<button type="button" class="btn btn-primary" id="btnAddDispatch">Add Dispatch</button>
				</div>
			</div>
		</div>
	</div>
				...
				<div class="modal-body border-0 modalBody">
					<form>
						...
						<div class="mb-3">
							...
							<select class="form-select selDispatchType" id="updateDispatchType" name="updateDispatchType">
								<option></option>
							</select>
						</div>
						<div class="mb-3">
							<label for="updateFinishedProductId">Finished Product List</label> 
							<select id="updateFinishedProductId" class="form-select updateFinishedProductId" name="updateFinishedProductId">
								<option></option>
							</select>
						</div>
						<div class="row mb-3">
							<div class="col-sm-6">
								<label for="txtQuantityFPL" class="col-form-label">Quantity</label>
								<input type="text" class="form-control txtQuantityFPL" name="txtQuantityFPL" readonly="readonly" />
							</div>
							<div class="col-sm-6">
								<label for="txtDateFinished" class="col-form-label">Date Finished</label> 
								<input type="text" class="form-control txtDateFinished" name="txtDateFinished" readonly="readonly" />
							</div>
						</div>
						<div class="mb-3">
							<label for="updateDispatchQuantity" class="col-form-label">Quantity:</label>
							<input type="number" class="form-control" id="updateDispatchQuantity" name="updateDispatchQuantity">
						</div>
						<div class="mb-3">
							<label for="updateDispatchDestination" class="col-form-label">Destination:</label>
							<input type="text" class="form-control" id="updateDispatchDestination" name="updateDispatchDestination">
						</div>
						<div class="mb-3">
							<label for="material-date">Dispatch Date:</label> 
							<input id="updateDate" class="form-control" type="date" name="material-date" />
						</div>
					</form>
				</div>
				<div class="modal-footer border-0 modalFooter">
					<button type="button" class="btn btn-success btnConfirmDate">Confirm
						Date</button>
	...
	<div class="modal fade" id="deleteModal" tabindex="-1"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body order-0 modalBody">
					<form>
						<div class="mb-3">
				...
				<div class="modal-footer border-0 modalHeader">
